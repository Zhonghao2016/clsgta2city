    ...
    for i_iter in range(args.num_steps):
        ...
        for sub_i in range(args.iter_size):
            ...
            if i_iter >= cls_begin_iter:
                ...
                target_label_gt = target_pred_cls.clone().detach()
                for i in range(args.num_classes):
                    target_label_gt[(target_pred_prob<thres[i])*(target_label_gt==i)] = 255
                loss_self_seg = seg_loss(pred_target2, target_label_gt)
            ...
            if i_iter >= cls_begin_iter:
                ...
                source_pred_prob, source_pred_cls = torch.max(pred_source_score, dim=1)
        ...
        print(
        'iter = {0:8d}/{1:8d}, loss_seg2 = {2:.3f}, loss_adv2 = {3:.3f} loss_D2 = {4:.3f} loss_cls_adv = {5:.3f} loss_cls_D = {6:.3f}'.format(
            i_iter, args.num_steps, loss_seg_value2, loss_adv_target_value2, loss_D_value2, loss_cls_adv_value, loss_cls_D_value))
